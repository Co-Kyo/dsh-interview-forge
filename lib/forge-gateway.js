...
async function discoverRoots(ctx) {
  ...
  try {
    ...
    const vals = typeof sessions?.list === "function" ? sessions.list() : typeof sessions?.values === "function" ? [...sessions.values()] : sessions && typeof sessions[Symbol.iterator] === "function" ? [...sessions] : [];
    for (const s of vals) {
